...
class TestVectorStore(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('chromadb.PersistentClient') as mock_client_class, \
            ...
            self.mock_client.get_or_create_collection.side_effect = get_or_create_collection
    ...
    def test_add_course_metadata(self):
        ...
        # Create test course
        lessons = [
            Lesson(lesson_number=1, title="Intro", lesson_link="http://lesson1.com", content=""),
            Lesson(lesson_number=2, title="Variables", lesson_link="http://lesson2.com", content="")
        ]
        course = Course(
            title="Python Basics",
            instructor="John Doe",
    ...
    def test_add_course_content(self):
        ...
        self.assertEqual(call_args[1]['documents'], ["This is chunk 1", "This is chunk 2"])
    ...
    def test_clear_all_data(self):
        ...
        self.assertEqual(self.mock_client.get_or_create_collection.call_count, 4)  # 2 in setUp + 2 in clear
