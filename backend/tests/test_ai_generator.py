...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_generate_response_with_tool_execution(self):
        ...
        final_response = MockAnthropicResponse("Here's what I found about Python variables...")
    ...
    def test_handle_tool_execution_multiple_tools(self):
        ...
        tool_block_1 = MockToolUseBlock("search_course_content", {"query": "python"}, "tool_1")
        tool_block_2 = MockToolUseBlock("get_course_outline", {"course_title": "Python"}, "tool_2")
        
        initial_response = MockAnthropicResponse(
            stop_reason="tool_use",
            tool_use_blocks=[tool_block_1, tool_block_2]
        )
        ...
        mock_tool_manager.execute_tool.assert_any_call("get_course_outline", course_title="Python")
    ...
    def test_no_tool_manager_with_tool_use(self):
        ...
        tool_use_response = MockAnthropicResponse(
            stop_reason="tool_use",
            tool_use_blocks=[MockToolUseBlock("search_course_content", {"query": "test"})]
        )
        ...
        self.assertEqual(result, "Tools were requested but no tool manager was provided to execute them.")
...
class TestAIGeneratorIntegration(unittest.TestCase):
    ...
    def test_content_query_triggers_tool_use(self):
        ...
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.return_value = "Functions are defined with def keyword..."
...
class TestSequentialToolCalling(unittest.TestCase):
    ...
    def test_sequential_two_round_tool_calling(self):
        ...
        first_response = MockAnthropicResponse(
            stop_reason="tool_use",
            tool_use_blocks=[first_tool_block]
        )
        ...
        second_response = MockAnthropicResponse(
            stop_reason="tool_use", 
            tool_use_blocks=[second_tool_block]
        )
        ...
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="functions", course_name="Advanced Python")
    ...
    def test_max_rounds_reached_with_final_synthesis(self):
        ...
        first_tool_block = MockToolUseBlock("search_course_content", {"query": "python"})
        first_response = MockAnthropicResponse(stop_reason="tool_use", tool_use_blocks=[first_tool_block])
        
        # Second round: Tool use  
        second_tool_block = MockToolUseBlock("get_course_outline", {"course_title": "Python"})
        second_response = MockAnthropicResponse(stop_reason="tool_use", tool_use_blocks=[second_tool_block])
        ...
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.side_effect = ["Search result 1", "Search result 2"]
    ...
    def test_tool_execution_failure_terminates_early(self):
        ...
        tool_block = MockToolUseBlock("search_course_content", {"query": "test"})
        response = MockAnthropicResponse(stop_reason="tool_use", tool_use_blocks=[tool_block])
    ...
    def test_message_structure_across_rounds(self):
        ...
        first_response = MockAnthropicResponse(stop_reason="tool_use", tool_use_blocks=[first_tool])
        second_response = MockAnthropicResponse(stop_reason="tool_use", tool_use_blocks=[second_tool])
...
class TestSequentialToolCallingIntegration(unittest.TestCase):
    ...
    def test_course_comparison_workflow(self):
        ...
        # Configure responses
        self.mock_client.messages.create.side_effect = [
            outline_response, search_response, final_response
        ]
        ...
        self.assertEqual(mock_tool_manager.execute_tool.call_count, 2)
        mock_tool_manager.execute_tool.assert_any_call("get_course_outline", course_title="Python Basics")
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="object-oriented programming", course_name="Advanced Python")
    ...
    def test_prerequisite_analysis_workflow(self):
        ...
        self.mock_client.messages.create.side_effect = [
            outline_response, prereq_response, final_response
        ]
        ...
        self.assertEqual(mock_tool_manager.execute_tool.call_count, 2)
        mock_tool_manager.execute_tool.assert_any_call("get_course_outline", course_title="Machine Learning with Python")
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="numpy pandas statistics", course_name="Python Data Science")
    ...
    def test_lesson_topic_discovery_workflow(self):
        ...
        lesson_search = MockToolUseBlock(
            "search_course_content",
            {"query": "lesson content", "course_name": "Web Development", "lesson_number": 5},
            "lesson_lookup"  
        )
        lesson_response = MockAnthropicResponse(
            stop_reason="tool_use",
            tool_use_blocks=[lesson_search]
        )
        ...
        self.mock_client.messages.create.side_effect = [
            lesson_response, topic_response, final_response
        ]
        ...
        self.assertEqual(mock_tool_manager.execute_tool.call_count, 2)
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="lesson content", course_name="Web Development", lesson_number=5)
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="API design REST endpoints")
    ...
    def test_error_handling_in_educational_workflow(self):
        ...
        # First tool succeeds
        outline_tool = MockToolUseBlock("get_course_outline", {"course_title": "Python"})
        outline_response = MockAnthropicResponse(stop_reason="tool_use", tool_use_blocks=[outline_tool])
        
        self.mock_client.messages.create.return_value = outline_response
        
        # Second tool fails
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.side_effect = Exception("Database connection timeout")
