...
class TestRAGSystem(unittest.TestCase):
    ...
    def test_init_creates_all_components(self):
        ...
        self.mock_tool_manager_instance.register_tool.assert_any_call(self.rag_system.search_tool)
        self.mock_tool_manager_instance.register_tool.assert_any_call(self.rag_system.outline_tool)
    ...
    def test_query_successful_content_search(self):
        ...
        self.mock_ai_generator_instance.generate_response.return_value = "Here's information about Python variables..."
        ...
        self.assertIn("Answer this question about course materials: Explain Python variables", call_args[1]['query'])
    ...
    def test_query_with_session_history(self):
        ...
        self.mock_session_manager_instance.get_conversation_history.return_value = "Previous conversation context"
        
        self.mock_ai_generator_instance.generate_response.return_value = "Response with context"
        self.mock_tool_manager_instance.get_last_sources.return_value = []
        ...
        self.assertEqual(call_args['conversation_history'], "Previous conversation context")
    ...
    def test_query_without_session_history(self):
        ...
        self.mock_ai_generator_instance.generate_response.return_value = "Response without history"
        self.mock_tool_manager_instance.get_last_sources.return_value = []
    ...
    def test_query_ai_generator_exception(self):
        ...
        self.mock_ai_generator_instance.generate_response.side_effect = Exception("API Error: Invalid API key")
    ...
    def test_get_course_analytics(self):
        ...
        mock_vector_store.get_existing_course_titles.return_value = [
            "Python Basics", "Advanced Python", "Data Science", "Web Development", "Machine Learning"
        ]
...
class TestRAGSystemIntegration(unittest.TestCase):
    ...
    def test_end_to_end_content_query_flow(self):
        ...
        self.mock_ai_generator_instance.generate_response.return_value = "Python functions are reusable blocks of code..."
        ...
        self.rag_system.tool_manager.get_last_sources = Mock(return_value=search_tool_mock.last_sources)
    ...
    def test_query_failure_scenarios(self):
        ...
        self.mock_ai_generator_instance.generate_response.side_effect = Exception("AuthenticationError: Invalid API key")
        ...
        self.mock_ai_generator_instance.generate_response.return_value = "I couldn't find information"
    ...
    def test_session_management_integration(self):
        ...
        self.mock_session_manager_instance.get_conversation_history.return_value = "User: What is Python?\nAssistant: Python is a programming language."
        
        self.mock_ai_generator_instance.generate_response.return_value = "Functions in Python are defined with the def keyword..."
        
        response, sources = self.rag_system.query("How do I create functions?", session_id=session_id)
        ...
        call_args = self.mock_ai_generator_instance.generate_response.call_args[1]
        self.assertIn("Python is a programming language", call_args['conversation_history'])
        
        # Verify conversation was updated
        self.mock_session_manager_instance.add_exchange.assert_called_once_with(
            session_id, "How do I create functions?", "Functions in Python are defined with the def keyword..."
        )
